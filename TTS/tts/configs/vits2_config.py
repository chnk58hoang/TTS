...
class Vits2Config(BaseTTSConfig):
    ...
    test_sentences: List[List] = field(
        default_factory=lambda: [
            ["Mục đích là làm quen với việc chủ động bắt đầu tương tác mà không cần câu chuyện phức tạp"],
            ["Khen một điều đơn giản với phụ nữ"],
            ["Hỏi đường hoặc nhờ giúp đỡ một người phụ nữ"],
        ]
    )
