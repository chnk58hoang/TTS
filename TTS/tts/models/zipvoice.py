...
from TTS.tts.layers.zipvoice.solver import EulerSolver
from TTS.tts.layers.zipvoice.zipformer import TTSZipformer
from TTS.tts.layers.zipvoice.common import (
    condition_time_mask,
    get_tokens_index,
    make_pad_mask,
    pad_labels,
...
class ZipVoice(BaseTTS):
    def __init__(
        ...
        self.text_encoder = TTSZipformer(
            in_dim=self.args.text_embed_dim,
            out_dim=self.args.feat_dim,
        ...
        self.embed = nn.Embedding(self.args.vocab_size, self.args.text_embed_dim)
